...
Пользователь с первичной регистрацией имеет доступ только к первичной функциональности, но не имеет доступа к полной функциональности - при попытке ею воспользоваться платформа должна сообщить пользователю об этом и предоставить ему возможность сделать полную регистрацию, чтобы получить доступ.
