...
### Концепция
Мы делаем продукт, который будет выходить только на российский рынок автомобильных грузоперевозок. Продукт будет представлять собой платформу-агрегатор, которая будет реализовывать функциональность отправителя, частично получателя и экспедитора. Должны быть реализованы:
1. Мобильное приложение для экспедиторов под IOS и Android
2. Веб приложение для отправителей под Chromium браузеры, Safari, Microsoft Edge и Mozilla Firefox
## Функциональные требования
### Функциональность, связанная с безопасностью
#### Электронный документооборот
...
### Функциональность отправителя
Реализуем все основные функциональности.
#### Создание заказа
